...
const handleAudioStatusChange = (payload, feature) => {
  console.log("payload", payload, feature)
  if (payload.muted) {
...
<!-- <template>
  <div class="jitsi-video"> 
    <JitsiMeeting
      ...
      @onJitsiMeetJSLoaded="handleJitsiMeetJSLoaded"
...
export default {
  ...
  data() {
    return {
      // domain: "meet.jit.si", // Jitsi Meet domain
      domain: "https://vcppoc1-service.test.axxess.tech/",
      roomName: "your-room-name", // Specify the room name
      jitsiOptions: {
        configOverwrite: {
        ...
        interfaceConfigOverwrite: {
          TOOLBAR_BUTTONS: [
            'microphone', 'camera', 'chat', 'tileview', 'fullscreen', 'raisehand',
          ],
        },
        userInfo: {
